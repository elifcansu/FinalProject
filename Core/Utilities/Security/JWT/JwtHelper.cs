...
namespace Core.Utilities.Security.JWT
{
    ...
    {
        public IConfiguration Configuration { get; } //apideki appsettingdeki dosyaları okumama yarıyor.
        private TokenOptions _tokenOptions; //okuduğum değerleri bu nesneye atıyoruz.
        private DateTime _accessTokenExpiration; //token ne zaman gerçekleşecek
        public JwtHelper(IConfiguration configuration)
        {
            Configuration = configuration;
            _tokenOptions = Configuration.GetSection("TokenOptions").Get<TokenOptions>();
            //appsetting içindeki süslü parantezler birer section onları al tokenoptions sınıfı ile eşle
